  ...
  <div class="space-y-6">
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-3">
          ...
          <div v-if="settings.dataSource !== 'dynamic' || !settings.contentLink?.data">
            <Label class="mb-1 block">Título</Label>
            <Input v-model="settings.title" placeholder="Digite o título" />
          </div>
          <div v-else>
            <Label class="mb-1 block">Título (Dinâmico)</Label>
          ...
          <div>
            <Label class="mb-1 block">Tamanho do Título</Label>
          ...
          <div>
            <Label class="mb-1 block">Peso do Título</Label>
          ...
          <div>
            <Label class="mb-1 block">Cor do Título</Label>
          ...
          <!-- Subtítulo -->
          <div v-if="settings.dataSource !== 'dynamic' || !settings.contentLink?.data">
            <Label class="mb-1 block">Subtítulo</Label>
            <Input v-model="settings.subtitle" placeholder="Digite o subtítulo" />
          </div>
          <div v-else>
            <Label class="mb-1 block">Subtítulo (Dinâmico)</Label>
            <div class="p-2 bg-gray-50 dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-700 text-sm">
              {{ settings.contentLink.data.description || 'Sem descrição' }}
            </div>
          </div>
          <div>
            <Label class="mb-1 block">Tamanho do Subtítulo</Label>
          ...
          <div>
            <Label class="mb-1 block">Cor do Subtítulo</Label>
    ...
    <template v-for="type in ['header', 'content', 'benefits', 'simulator', 'contact-channels', 'cards', 'form']" :key="type">
      <template v-if="component?.type === type">
        ...
        <!-- Configurações específicas para canais de contato -->
        ...
        <!-- Configurações específicas para formulário -->
        ...
        <template v-if="type === 'cards'">
          <div class="space-y-4">
            ...
            <div v-if="settings.cards && settings.dataSource !== 'dynamic'" class="space-y-4">
