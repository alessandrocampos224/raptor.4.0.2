 ...
 * Class StoreService
 * 
 * Serviço responsável pela lógica de negócios relacionada ao modelo Store.
...
class StoreService extends AbstractService
{
     ...
     * 
     * @param Store $model Instância do modelo
     * @param Request $request Requisição HTTP atual
     */
    public function __construct(Store $model, Request $request)
    {
     ...
     * lógicas de negócio específicas para o modelo Store, como:
     * 
