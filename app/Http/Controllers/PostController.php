 ...
 * 
 * Controller responsável por gerenciar operações CRUD para o modelo Post.
...
class PostController extends AbstractController
{
     ...
     * 
     * @param PostService $service Serviço que contém a lógica de negócios
     */
        ...
        return $table
            ...
            ->bulkActions([
                DeleteBulkAction::make('Excluir Selecionados')
                    ...
                    ->url(fn($model) => route('posts.destroy', $model->id)),
            ]);
    }
    ...
    /**
     * Retorna uma lista de posts para uso no construtor de páginas
     * 
     * @return \Illuminate\Http\JsonResponse
     */
    public function getPostsForPageBuilder()
    {
        try {
