 ...
 * Class UpdateRequest
 * 
 * Classe de validação para requisições de atualização de registros Page.
...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => 'sometimes|required|string|max:255|unique:pages,slug,' . $this->id,
            'title' => 'sometimes|required|string|max:255',
            'tipo' => 'sometimes|required|string',
            'description' => 'nullable|string',
            'status' => 'sometimes|required|string',
            'config' => 'sometimes|array',
            'config.components' => 'sometimes|array',
            'config.globalStyles' => 'sometimes|array',
